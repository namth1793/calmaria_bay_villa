export const rooms = [
  {
    ...
    reviews: [
      { name: 'Minh Hải', avatar: '👨', rating: 5, date: 'Tháng 3, 2026', text: 'Phòng rất sạch sẽ và thoáng mát. View sân vườn yên tĩnh, ngủ rất ngon. Nhân viên nhiệt tình.' },
      { name: 'Lan Anh', avatar: '👩', rating: 5, date: 'Tháng 3, 2026', text: 'Không gian đẹp, giường thoải mái. Hồ bơi villa tuyệt vời. Sẽ quay lại lần sau!' },
      { name: 'Tuấn', avatar: '🧑', rating: 4, date: 'Tháng 2, 2026', text: 'Phòng ổn, view vườn khá đẹp. Cơ sở vật chất đầy đủ. Giá hợp lý.' },
    ],
    similar: [2, 3, 4],
  },
  {
    ...
    reviews: [
      { name: 'Trần Khánh', avatar: '👨', rating: 5, date: 'Tháng 3, 2026', text: 'Ban công tầng 3 nhìn xuống vườn rất đẹp. Phòng nhỏ nhưng tiện nghi đủ đầy. Rất hài lòng.' },
      { name: 'Na', avatar: '👩', rating: 5, date: 'Tháng 3, 2026', text: 'Tuyệt vời! Buổi sáng ngồi ban công ngắm vườn, rất thư giãn. Nhất định sẽ quay lại.' },
    ],
    similar: [1, 3, 4],
  },
  {
    ...
    reviews: [
      { name: 'Phương Thảo', avatar: '👩', rating: 5, date: 'Tháng 3, 2026', text: 'Phòng rộng rãi, sạch sẽ. View vườn rất mát mẻ. Dịch vụ tốt, sẽ giới thiệu cho bạn bè.' },
      { name: 'Đức Anh', avatar: '👨', rating: 5, date: 'Tháng 3, 2026', text: 'Không gian đủ rộng cho gia đình nhỏ. Nhân viên nhiệt tình. Hồ bơi villa tuyệt vời!' },
    ],
    similar: [4, 5, 1],
  },
  {
    ...
    reviews: [
      { name: 'Bảo Châu', avatar: '👩', rating: 5, date: 'Tháng 3, 2026', text: 'Phòng tầng 2 rất yên tĩnh. Vườn nhìn xuống rất đẹp. Gia đình mình rất hài lòng.' },
      { name: 'Hùng', avatar: '👨', rating: 4, date: 'Tháng 3, 2026', text: 'Phòng sạch sẽ, tiện nghi đủ đầy. Dịch vụ chuyên nghiệp. Sẽ quay lại lần sau.' },
    ],
    similar: [3, 5, 1],
  },
  {
    ...
    reviews: [
      { name: 'Thủy', avatar: '👩', rating: 5, date: 'Tháng 3, 2026', text: 'Phòng tầng cao, rất yên tĩnh. View nhìn xuống vườn cây xanh mát. Rất thích!' },
      { name: 'Dũng', avatar: '👨', rating: 5, date: 'Tháng 3, 2026', text: 'Sạch sẽ, thoáng mát. Nhân viên phục vụ tận tình. Hồ bơi villa rất đẹp.' },
    ],
    similar: [3, 4, 2],
  },
  {
    ...
    reviews: [
      { name: 'Hương Giang', avatar: '👩', rating: 5, date: 'Tháng 3, 2026', text: 'View biển từ phòng tuyệt vời! Phòng rộng và sang trọng. Gia đình mình rất thích!' },
      { name: 'Bảo Long', avatar: '👨', rating: 5, date: 'Tháng 3, 2026', text: 'Phòng rộng rãi, view biển đẹp. Ngủ dậy nhìn ra vịnh Hạ Long thật tuyệt vời.' },
    ],
    similar: [7, 8, 9],
  },
  {
    ...
    reviews: [
      { name: 'Minh Châu', avatar: '👩', rating: 5, date: 'Tháng 3, 2026', text: 'Tầng 3 nhìn ra biển rộng lắm! Phòng sạch đẹp, tiện nghi đủ. Nhân viên thân thiện.' },
      { name: 'Hoàng', avatar: '👨', rating: 5, date: 'Tháng 3, 2026', text: 'View biển từ tầng 3 quá đẹp. Phòng rộng rãi, nghỉ ngơi rất thoải mái.' },
    ],
    similar: [6, 8, 9],
  },
  {
    ...
    reviews: [
      { name: 'Ngọc Anh', avatar: '👩', rating: 5, date: 'Tháng 3, 2026', text: 'Ban công view biển siêu đẹp! Buổi sáng ngồi ban công uống cà phê ngắm vịnh Hạ Long, không có gì tuyệt vời hơn!' },
      { name: 'Tuấn Anh', avatar: '👨', rating: 5, date: 'Tháng 3, 2026', text: 'Phòng rộng rãi, ban công đẹp. Nhìn ra biển cả mênh mông. Xứng đáng 5 sao!' },
      { name: '정민', avatar: '🧑', rating: 5, date: 'Tháng 3, 2026', text: 'Amazing balcony with ocean view! Room is very clean and comfortable. Best experience!' },
    ],
    similar: [9, 10, 6],
  },
  {
    id: 9,
    name: 'Phòng 302',
    fullName: 'Phòng 302 – Deluxe Sea View + Ban công | 32m²',
    size: '32m²',
    guests: 2,
    beds: 1,
    bedrooms: 1,
    ...
    about: `Phòng 302 là phòng Deluxe rộng 32m² hướng biển có ban công tại tầng 3. Vị trí tầng cao cùng ban công riêng mang lại tầm nhìn panorama ra vịnh Hạ Long.\n\nĐiểm nổi bật:\n- Tầng 3, tầm nhìn biển cao và rộng nhất\n- Ban công riêng hướng biển – không gian ngoài trời lý tưởng\n- View panorama vịnh Hạ Long từ ban công\n- Bãi biển riêng chỉ cách 30m\n\nPhù hợp cho 2 người lớn và 1 trẻ em dưới 7 tuổi.`,
    bedrooms_detail: [
      { name: 'Phòng ngủ', type: 'King bed x 1' },
    ],
    amenities: ['Điều hòa', 'Tivi', 'Máy sấy tóc', 'Nước nóng', 'Wifi'],
    ...
    reviews: [
      { name: 'Phúc', avatar: '👨', rating: 5, date: 'Tháng 3, 2026', text: 'Ban công tầng 3 view biển cực đẹp. Phòng rộng, sạch sẽ. Dịch vụ 5 sao!' },
      { name: 'Linh Chi', avatar: '👩', rating: 5, date: 'Tháng 3, 2026', text: 'Tuyệt vời! Ngồi ban công nhìn ra vịnh Hạ Long buổi hoàng hôn đẹp mê hồn. Sẽ quay lại!' },
    ],
    similar: [8, 10, 7],
  },
  {
    ...
    reviews: [
      { name: 'Hà My', avatar: '👩', rating: 5, date: 'Tháng 3, 2026', text: 'Phòng đẹp nhất tôi từng ở! Ban công nhìn ra biển Hạ Long, buổi sáng thức dậy nhìn bình minh thật tuyệt.' },
      { name: 'Khoa', avatar: '👨', rating: 5, date: 'Tháng 3, 2026', text: 'Sang trọng, rộng rãi, view biển tuyệt đẹp. Dịch vụ villa rất chuyên nghiệp. 5 sao!' },
    ],
    similar: [8, 9, 6],
  },
];
