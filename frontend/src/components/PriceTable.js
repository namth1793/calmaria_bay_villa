...
const ROWS = {
  vi: [
    ...
    { rooms: 'Thuê nguyên căn — Cuối tuần (T6, T7, CN)', area: '346m² · 10 phòng', view: '20 NL + 10 trẻ em', note: 'Trọn gói cuối tuần', price: '22,200,000', highlight: false },
    { rooms: 'Thuê nguyên căn — Trong tuần (T2 – T5)', area: '346m² · 10 phòng', view: '20 NL + 10 trẻ em', note: 'Ngày thường', price: '16,650,000', highlight: false },
    { rooms: '🎉 Nguyên căn — Ngày lễ lớn (30/4, 1/5, 2/9)', area: '346m² · 10 phòng', view: '20 NL + 10 trẻ em', note: 'Lễ đặc biệt', price: '30,200,000', highlight: true },
  ],
  en: [
    ...
    { rooms: 'Full Villa — Weekend (Fri, Sat, Sun)', area: '346m² · 10 rooms', view: '20 Adults + 10 Children', note: 'Weekend package', price: '22,200,000', highlight: false },
    { rooms: 'Full Villa — Weekday (Mon – Thu)', area: '346m² · 10 rooms', view: '20 Adults + 10 Children', note: 'Weekday rate', price: '16,650,000', highlight: false },
    { rooms: '🎉 Full Villa — Public Holidays (Apr 30, May 1, Sep 2)', area: '346m² · 10 rooms', view: '20 Adults + 10 Children', note: 'Holiday special', price: '30,200,000', highlight: true },
  ],
};
