...
const T = {
  vi: {
    ...
    sub: 'Điền thông tin để gửi yêu cầu đặt phòng. Chúng tôi sẽ xác nhận trong vòng 24 giờ.',
    ...
    submit: 'Đặt phòng ngay',
    submitting: 'Đang gửi...',
    zaloBtn: 'Liên hệ qua Zalo',
    successTitle: 'Đặt phòng thành công!',
    successDesc: 'Chúng tôi đã nhận yêu cầu của bạn và sẽ liên hệ xác nhận qua điện thoại/Zalo sớm nhất.',
  ...
  en: {
    title: 'Book Online',
    sub: 'Fill in your details to send a booking request. We will confirm within 24 hours.',
    ...
    successDesc: 'We have received your request and will contact you to confirm via phone/Zalo as soon as possible.',
